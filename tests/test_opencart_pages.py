...
from page_objects.admin_page_login import AdminPage
from page_objects.admin_page_products import AdminPageProducts
...
@allure.title('Проверка запуска теста в Дженкинс')
def test_check_jenk(browser):
    browser.get(browser.base_url)
    assert True